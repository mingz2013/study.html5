...
frame.AdSense = /*cc.Class.extend(*/{
    ...
    createDiv:function() {
        ...
        //mainContainer.style.transform = transformStr;
        //
        ...
        //mainContainer.appendChild(this.adContainerDiv);
        //
        //console.log('mainContainer=', mainContainer);

        //------------------------------------------------------

        var advertiseDiv = document.getElementById("advertise");
